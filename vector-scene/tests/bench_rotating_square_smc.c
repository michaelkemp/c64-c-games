...
/* Identical to bench_rotating_square.c except the square is drawn with
   draw_line_smc() (trick #2b) instead of draw_line_asm() (trick #2) --
   see src/main_smc.c and README.md's "Trick #2b" and "Trick #3"
   sections. bench_rotating_square.c is left as-is for direct
...
int main(void)
{
    ...
    clrscr();
    cprintf("rotating square (smc): %u frames\r\n\r\n", (unsigned)TOTAL_FRAMES);
